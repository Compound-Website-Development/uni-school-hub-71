...
import StaffReportCard from "./pages/staff/StaffReportCard";
    ...
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        <TooltipProvider>
          ...
          <ErrorBoundary>
          <Routes>
            {/* Public marketing homepage is hidden for now — visitors land on the portal login */}
            ...
            <Route path="/staff/report-card" element={<ProtectedRoute allowedRoles={["teacher", "admin"]}><StaffReportCard /></ProtectedRoute>} />
