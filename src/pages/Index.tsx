    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-3">
              <img src={npsLogo} alt="Imagemakers Nursery and Primary School" className="h-10 w-auto" />
            </Link>
      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 text-center">
          <img src={npsLogo} alt="Imagemakers Nursery and Primary School" className="h-16 md:h-20 mx-auto mb-8 animate-fade-in" />
          ...
          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-up animation-delay-100">
            A complete school management platform built for Imagemakers Nursery and Primary School. Results, attendance, fees, and more — all in one place.
          </p>
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">Powerful tools designed specifically for Imagemakers Nursery and Primary School</p>
          </div>
      ...
      <section className="py-20 md:py-28 bg-gradient-hero relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">Join hundreds of Imagemakers Nursery and Primary School already using our platform.</p>
          <Link to="/login">
      ...
      <footer className="bg-card border-t border-border py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <img src={npsLogo} alt="Imagemakers Nursery and Primary School" className="h-7 w-auto" />
            <div className="flex items-center gap-6 text-sm text-muted-foreground">
              <Link to="/login" className="hover:text-foreground transition-colors">Sign In</Link>
              <Link to="/apply" className="hover:text-foreground transition-colors">Apply</Link>
            </div>
            <p className="text-sm text-muted-foreground">Imparting Wisdom and Morals</p>
          </div>
        </div>
      </footer>
    </div>
