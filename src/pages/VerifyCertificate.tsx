    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-border/50">
        <CardContent className="p-8 text-center">
          <img src={npsLogo} alt="Imagemakers" className="h-12 mx-auto mb-4" />
          <h1 className="text-xl font-bold text-foreground mb-1">Certificate Verification</h1>
          <p className="text-sm text-muted-foreground mb-6">Imagemakers Nursery and Primary School — Digital Verification Portal</p>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 justify-center text-xs text-muted-foreground">
                <Shield className="w-3 h-3" /> Digitally verified by Imagemakers Portal
              </div>
            </div>
          ) : (
            <div className="py-8">
