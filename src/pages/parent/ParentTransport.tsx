...
const ParentTransport = () => {
  ...
  return <ParentLayout title="School Bus">
    <div className="dashboard-surface dashboard-parent mx-auto max-w-5xl space-y-6">
      <div className="rounded-3xl bg-gradient-to-br from-primary to-primary/75 p-6 text-primary-foreground shadow-xl">
